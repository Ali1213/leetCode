...
/**
 * Runtime: 112 ms, faster than 17.57% of JavaScript online submissions for Previous Permutation With One Swap.
 * Memory Usage: 38.2 MB, less than 100.00% of JavaScript online submissions for Previous Permutation With One Swap.
 * @param {number[]} A
 * @return {number[]}
 */
...
test.forEach(([A, r]) => {
    assert.deepEqual(prevPermOpt1(A), r)
})

/** 
 * Runtime: 96 ms, faster than 94.59% of JavaScript online submissions for Previous Permutation With One Swap.
 * Memory Usage: 38.2 MB, less than 100.00% of JavaScript online submissions for Previous Permutation With One Swap.
 */
var prevPermOpt1 = function (A) {
    let n = A.length;
